...
public class ProjectActivityAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
    private Context context;
    private List<ProjectActivityModel> list;

    public ProjectActivityAdapter(Context context, List<ProjectActivityModel> list) {
